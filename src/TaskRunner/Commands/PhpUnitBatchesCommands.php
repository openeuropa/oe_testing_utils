...
namespace OpenEuropa\TestingUtilities\TaskRunner\Commands;
...
/**
 * Defines ec-europa/toolkit commands to run tests in batches.
 */
class PhpUnitBatchesCommands extends AbstractCommands {
